...
function PasswordValidator({ setSection }) {
  ...
  return (
    <div class="auth_section set_password">
      <div class="login_title">
        <h2>Создать пароль</h2>
      </div>
      <div class="login_form_temp">
        <div class="login_input_titles">
          <p>Пароль</p>
        </div>
        <div class="login_input mb_10px">
          <input
