    ...
    <div className="base_page_wrapper">
      ...
      <div className="pages_wrapper register_page">
        ...
        <div className="text_pages_wrapper">
          ...
          <h2>Инвесторы должны осознавать эти риски и принимать меры по их снижению, вне зависимости от условий рынка.</h2>
