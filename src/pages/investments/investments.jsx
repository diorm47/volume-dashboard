...
function Investments({ updatebalance, setRec }) {
  ...
  const faq = [
    {
      question: "Какое максимальное количество алгоритмов можно запустить одновременно?",
      answer: "",
    },
    {
    ...
    {
      question: "Где я могу увидеть результаты торговли алгоритма за предыдущие периоды?",
      answer: "",
    },
    {
    ...
    {
      question: "Как понять, что алгоритм функционирует и запуск прошёл успешно?",
      answer: "",
    },
  ];
  const faqEn = [
