export const ru_locale = {
  ...
  bybit: {
    desc1: 'Нажмите на кнопку «Подключить в один клик»',
    desc2: 'Войдите в свой аккаунт на Торговой площадке',
    desc3: 'Подтвердите подключение на &Volume',
    button: 'Подключить в один клик'
  }
};
