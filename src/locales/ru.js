export const ru_locale = {
  ...
  rev_5: "Закрытые сделки",
  rev_5_1: "Здесь отображается список закрытых сделок ",
  rev_6: "Здесь отображается список последних 10 закрытых сделок",
  rev_7: "Нет истории сделок",
  ...
  executed_orders_title: "Открытые сделки",
  executed_orders_description: "Здесь отображается список открытый сделок",
  long_order: "Long",
  short_order: "Short",
  no_open_orders: "Нет открытых сделок",
  no_order_history: "Нет закрытых сделок",
  ...
  algo_empty: {
    title: "Здесь будут ваши алгоритмы",
    desc1: "У вас нет активных алгоритмов,",
    desc2: "создайте свой алгоритм.",
    button: "Создать алгоритм",
  },
  api_empty: {
    title: "Здесь будут ваши API ключи",
    desc1: "У вас нет подключенных API ключей,",
    desc2: "подключите API ключи вашей биржи.",
  },
  api_auto: "Быстрое подключение",
  api_handle: "Ручное подключение",
  invitation: {
    title: "Приглашение",
    desc: "Приглашайте друзей в &Volume и получайте награды до 30% от стоимости тарифа. ",
    btn: "Пригласить",
  },
  graph: "График",
  ...
  ref_1_block: {
    title: "Доход",
    desc: "Здесь отображается ваш доход с рефералов",
    all: "Общий доход",
    have: "Доступно",
    btn: "Вывести",
  },
  ref_2_block: {
    ...
    desc: "Здесь отображается ваша актуальная реферальная ссылка",
    link: "Ссылка",
  },
  ref_3_block: {
    title: "Рефералы",
    desc: "Здесь отображается список ваших рефералов",
    thead1: "ID Пользователя",
    thead2: "Оплаченный тариф",
    thead3: "Доход",
    thead4: "Дата регистрации",
    empty: "Нет рефералов",
  },

  output1: {
    title: "Заявка на вывод",
    btitle1: "Выберите валюту вывода",
    btitle2: "Адрес кошелька для перевода",
    desc1: "В рабочие дни с 10:00 до 20:00 (GMT+3) вывод осуществляется в",
    desc1_1: "течение рабочего дня. В остальное время — на следующий день.",
    desc2: "К выводу доступна только полная сумма, хранящаяся на балансе.",
    desc3: "Минимальная сумма вывода 100 USDT.",
    path: "шаг 1 из 2",
    btn: "Далее",
  },
  output2: {
    title: "Заявка на вывод",
    text1: "Вы отправляете",
    text2: "Адрес",
    path: "шаг 2 из 2",
    btn: "Вывод средств",
  },
  ...
  investmentsCards: {
    warning:
      "Для каждого алгоритма есть подробная информация о принципах его работы, рисках, рекомендациях и результатах, полученных на основе анализа исторических данных. Исходя из своих целей, вы можете выбрать один алгоритм или комбинировать несколько, настраивая стратегию и уровень риска.",
    more_det: "Подробнее",
    delta_des:
      "Подходит для долгосрочного планирования. Больше зарабатывает на росте, меньше на падении. При значительном падении рынка, от -50% и ниже, совершает меньше сделок и сохраняет депозит. В среднем совершает 1-2 сделки в день.",
    sigma_des:
      "Зарабатывает на росте и падении рынка, реагирует на импульсное движение цены, подбирает оптимальные точки входа в зависимости от волатильности рынка. Показывает хорошую эффективность даже на короткой дистанции.",
    place: "Торгуемая площадка",
    risk: "Уровень риска",
    minimal: "Минимальный",
    average: "Средний",
  ...
  createAlgo: {
    ...
    birja: "Биржа",
    birja_p: "Выберите биржу",
    api: "API-ключ",
    api_p: "Выберите ключ",
    api_add: "Добавить новый API-ключ",
    settings_reg: "Режим настройки",
    sr_auto: "Автоматический",
    sr_han: "Ручной",
    sr_rec: "Рекомендуем",
    sr_reg_auto:
      "Алгоритм самостоятельно подберёт оптимальные настройки в зависимости от рыночной ситуации, без вашего участия.",
    sr_reg_han:
      "Настройте алгоритм и подберите оптимальные параметры торговли, которые подойдут именно вам.",

    reinv: "Реинвестирование прибыли",
    trade_pairs: "Торговые пары",
    trade_pairs_se: "Выберите торговые пары",
    depos: "Депозит",
    depo_s: "Укажите сумму депозита",
    depo_d: "Доступно",
    q_a_o: "Максимальное кол-во активных сделок",
    qoas: "Укажите максимальное кол-во активных сделок",
    order_ob: "Объём сделки",
    order_ob_s: "Укажите объём сделки",
    plecho: "Плечо",
    plecho_s: "Укажите плечо",
    stopl: "Стоп-лосс",
    stopls: "Укажите стоп-лосс",
    create_btn: "Создать алгоритм",
    cancel_btn: "Отмена",
  },
  createAlgoSec: {
    depo_err1: "Депозит не может быть менее 100 USDT, увеличьте депозит",
    depo_err2:
      "Депозит выше доступной суммы на балансе, уменьшите сумму депозита",
    activetr_err1: "Максимальное кол-во активных сделок не может быть больше",
    activeetr_err2:
    ...
    volume_err3: "Объём сделки не может быть больше 100%",
    plecho_err1: "Плечо не может быть более 10x, снизьте плечо",
    plecho_err2: "Плечо не может быть менее 1x, увеличьте плечо",
    trade_s: "Торговля разрешена",
    trade_f: "Торговля запрешена",
    sett_rej: "Выберите режим настройки алгоритма",
    reinv_d: "Использовать в торговле полученную прибыль",
    depo_d: "Укажите выделенную сумму депозита для алгоритма",
    stoplos_d: "Укажите сумму максимального убытка в % от депозита",
    stop_w1: "Если ваш чистый убыток достигнет",
    stop_w2: "торговля прекратится",
    pairs_d: "Выберите торговые пары для торговли ",
    volume_d: "Укажите обьем сделки в % от депозита",
  },
  algo_type_sigma: {
    warning:
      "Информация на странице получена по результатам тестирования алгоритма на историческом периоде и не может гарантировать аналогичную эффективность в будущем.",
    doxod: "Доходность за все время",
    ...
    testing2: "Дата создания",
    testing3: "Чистый П/У в %",
    testing4: "Среднегодовая доходность",
    testing5: "Среднемесячная доходность",
    testing6: "Количество сделок",
    testing7: "Прибыльных сделок в %",
    testing8: "Убыточных сделок в %",
    testing9: "Макс. просадка в %",
  ...
  algo_type_sigma_d: {
    title1: 'Алгоритм основан на контртрендовой стратегии среднеквадратичного отклонения цены',
    desc11: 'Реагирует на импульсное движение цены и подбирает оптимальные точки входа в зависимости от волатильности рынка. Сеточные, или grid методы торговли, отсутствуют.',
    desc12: 'AI реагирует на краткосрочное отклонение от основного тренда, определяет вероятность направления движения цены и находит оптимальную точку входа в сделку.',
    desc13: 'Алгоритм учитывает волатильность рынка и совершает сделки при оптимальных параметрах, не дожидаясь идеальных условий. Это позволяет увеличить прибыль и минимизировать убытки.',
    title2: 'Преимущества алгоритма',
    desc21: 'AI за секунды реагирует на изменения цены и подбирает оптимальную точку продажи позиции. Это позволяет избежать зависание позиции на часы и дни, а закрывать большинство сделок в течение минуты после открытия.',
    desc22: 'Алгоритм контролирует риск и использует набор метрик волатильности. Метрики используются для поиска оптимальных точек усреднения позиции, что позволяет выгоднее закрывать сделку.',
    pnl: 'График PnL',
    pnl_m: 'График PnL по месяцам',
  }
};
